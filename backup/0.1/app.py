...
def seed_db_command():
    ...
    try:
        ...
        for owner in owner_objects:
            ...
            # PERBAIKAN: Hardcode nomor register agar urut mulai dari REG001 untuk SETIAP owner
            supplier_data = [
                # Kita gunakan format standar aplikasi sekarang: REGxxx
                {"nama": f"Supplier A ({owner.username})", "user": f"supp_a_{owner.username}", "reg": "REG001", "metode": "BCA", "rek": "123456789"},
                {"nama": f"Supplier B ({owner.username})", "user": f"supp_b_{owner.username}", "reg": "REG002", "metode": "DANA", "rek": "08123456789"},
            ]
            ...
            for data in supplier_data:
                ...
                print(f"    > Supplier '{data['user']}' dibuat dengan No Reg: {data['reg']}")
